...
library(knitr)
opts_chunk$set(comment=NA, echo=F, cache=T, tidy=F, message=F, warning=F, dev=c('png', 'pdf'), dpi=300, results='hide',  fig.height=4.5, fig.width=4.5) 
options(width=100)
...
legend('top', legend=c(expression(R[0]==2.5), expression(R[0]==1), expression(R[0]==0.85)), col=r0_cols, pch=rep(16), bty='n', horiz=T, xpd=T, inset=c(0, -0.1))
